...
\begin{itemize}
      ...
      \item \emph{\textbf{Data}}: It is always crucial to have a proper set of
            ...
            whole process.
      \item \emph{\textbf{Model Hypotheses}}: In general, it is always possible to
            choose, from a large family of machine learning models, a particular
            model structure that will be suitable for the task.
      \item \emph{\textbf{Objective}}: It is always necessary to define an objective

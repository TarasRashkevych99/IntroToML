...
% TODO: add an entry for "FIXME" in the config file of the extension
\begin{figure}[h]
      \centering
...
At this point, it is possible to introduce two major machine learning
tasks that use the supervised learning structure defined above:

\begin{itemize}
      \item \emph{\textbf{Classification}}: Given a \underline{finite}
            ...
            is the dimension of the input space and $k$ is the total
            number of labels, to predict the label $y$ given the input
            $x$. So the dimension of the $x$ component(feature vector)
            in the pairs of labeled examples and as input to the
            function $f$ is determined by the value of $d$, as can be
            ...
            Recognition, Spam Detection, Medical Diagnosis, and
            Biometrics.
